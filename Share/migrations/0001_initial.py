    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['post'], name='share_post_idx'), models.Index(fields=['user'], name='share_user_idx'), models.Index(fields=['created_at'], name='share_created_at_idx')],
